...
//  vadmitrievaPW3
//
//  Created by Varvara on 11.10.2021.
//
...
class TableView: UIView {
    ...
    init(a: AlarmView, w: Int){
        alarm = AlarmView(time: a.time, isActive: a.isActive)
        super.init(frame: CGRect(x: 0, y: 0, width: w, height: 40))
        setupTimeText()
    ...
    private func setupActivationToggle() {
        ...
        activationToggle.trailingAnchor.constraint(
            equalTo: self.trailingAnchor, constant: -50 ).isActive = true
